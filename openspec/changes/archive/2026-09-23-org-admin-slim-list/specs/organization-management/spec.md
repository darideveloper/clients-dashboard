...
- **THEN** the list SHALL display "name", "Orders", "Rep", "Last Order", "Usage %" and "Combined total" last, be searchable by name, and sortable by name
